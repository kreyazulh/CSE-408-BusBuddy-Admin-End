<script>
  ...
  <main class="flex min-h-screen min-w-full bg-gradient-to-b from-maroon-500 via-maroon-900 to-black-900">
    ...
    <div class="flex justify-end mb-8">
        ...
        <button on:click={addNotice} class="btn bg-blue-500 hover:bg-blue-700 text-white-700 font-bold py-2 px-4 rounded">Add Notice</button>
      </div>
  
      <!-- Notices display -->
      <div class="max-w-md mx-auto bg-maroon-500 p-6 rounded-lg shadow-lg">
        {#if notices.length > 0}
          <div class="space-y-4">
            {#each notices as notice}
              <div class="p-4 bg-white-700 rounded-lg shadow-md">
