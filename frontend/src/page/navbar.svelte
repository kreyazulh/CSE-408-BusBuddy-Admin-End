...
<div class="min-h-screen flex flex-row bg-white-700">
  <div class="flex flex-col w-56 bg-maroon-500 rounded-r-3xl overflow-hidden h-full postion: fixed">
    ...
    <ul class="flex flex-col py-4">
      ...
      <li>
        <Link to="/requisitionList" class="Link flex flex-row items-center h-10 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-white-700 focus:shadow focus:text-white-700 focus:translate-y-0.5">
