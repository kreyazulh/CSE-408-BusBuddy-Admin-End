<script>
  ...
  function updateEntriesToShow(event) {
   ...
   function updateSearchQuery(event) {
    ...
    if (searchQuery.trim() === "") {
      searchRows = bus_staffs; // If the search query is empty, show all rows
    } else {
      // Filter rows based on the searchQuery
      searchRows = bus_staffs.filter((row) => {
...
<main class="flex min-h-screen min-w-full">
  ...
  <div class="flex mb-4 justify-end">
    <button
      ...
      on:click={gotoAddStaff}> Add Bus Staff</button>
              ...
              <th class="bg-white-700  w-1/5">
                ...
                >
                  ...
                  <div class="flex flex-col">
                    <button
                      class="h-3 bg-transparent transform scale-75"
                      on:click={() => sortTable("name", "asc")}
                    >
                      <span
                        class="inline-block ml-1 my-0 text-xs text-maroon-900 hover:text-black-900"
                        class:shrink={shrinkID === "nameasc"}>▲</span
                      >
                    </button>
                    <button
                      class="bg-transparent transform scale-75"
                      on:click={() => sortTable("name", "desc")}
                    >
                      <span
                        class="inline-block ml-1 my-0 text-xs text-maroon-900 hover:text-black-900"
                        class:shrink={shrinkID === "namedesc"}>▼</span
                      >
                    </button>
                  </div>
                </div>
                ...
                <th class="bg-white-700  w-1/5">
                  ...
                  >
                    ...
                    <div class="flex flex-col">
                      <button
                        class="h-3 bg-transparent transform scale-75"
                        on:click={() => sortTable("role", "asc")}
                      >
                        <span
                          class="inline-block ml-1 my-0 text-xs text-maroon-900 hover:text-black-900"
                          class:shrink={shrinkID === "roleasc"}>▲</span
                        >
                      </button>
                      <button
                        class="bg-transparent transform scale-75"
                        on:click={() => sortTable("role", "desc")}
                      >
                        <span
                          class="inline-block ml-1 my-0 text-xs text-maroon-900 hover:text-black-900"
                          class:shrink={shrinkID === "roledesc"}>▼</span
                        >
                      </button>
                    </div>
                  </div>
              ...
              <tbody>
                ...
                <tr
                  class="{index % 2 === 0
                    ...
                    <td class="py-2 pl-2 pr-2 text-center w-1/6">{row.id}
                    </td>
                    <td class="py-2 pl-2 pr-2 text-center w-1/5">{row.name}
                    </td>
                    <td class="py-2 pl-2 pr-2 text-center w-1/5">{row.role}
                    </td>
                    <td class="py-2 pl-2 pr-2 text-center w-1/6">{row.phone}
                    </td>
