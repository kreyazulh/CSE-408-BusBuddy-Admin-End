    ...
    <ul class="flex flex-col py-4">
      ...
      <li class="relative">
        ...
        {#if dropdowns.has('Trips')}
          <ul class="w-full z-10 flex flex-col bg-maroon-900 transition-transform ease-in-out duration-200">
            <li>
              <Link to="/scheduleTrip" class="Link translate-x-5 flex flex-row items-center h-10 transform hover:translate-x-1.5 transition-transform ease-in duration-200 text-gray-300 hover:text-white-700 focus:translate-y-0.5 focus:shadow focus-bg-maroon-900">
      ...
      <li>
        <Link to="/noticeList" class="Link flex flex-row items-center h-10 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-300 hover:text-white-700 focus:shadow focus:text-white-700 focus:translate-y-0.5 ">
          <span class="inline-flex items-center justify-center h-10 w-12 text-lg focus:text-white-700"><i class="bx bxs-bell"></i></span>
